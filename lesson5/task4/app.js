...
let htmlTagButtons = document.querySelectorAll('button');

// 1.1 затем проитерируйтесь по кнопкам и каждой из
// них добавьте обработчик клика - функцию handleClick

htmlTagButtons.forEach(function(htmlTagButton){
    htmlTagButton.addEventListener('click', function(event){
        handleClick(event);
    })
})
...
function showMoreText(card) {
    ...
    let loremText = "Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique excepturi consequatur aspernatur voluptates debitis quidem autem sint explicabo doloremque blanditiis cum laboriosam et hic magni, aliquam alias, dolores totam minus."
